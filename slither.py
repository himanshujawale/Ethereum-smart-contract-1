...
from detector_api.suicidal import Suicidal
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("To generate the json file run cmd:  \n\t python slither.py --generate </filename> ",sep="\n")

    elif sys.argv[1] == "--generate":
        print("file_name:- ",sys.argv[2])
        analyzer._generate_test(sys.argv[2], skip_existing=True)

    elif sys.argv[1] == "--overwrite":
        analyzer._generate_test(sys.argv[2])
